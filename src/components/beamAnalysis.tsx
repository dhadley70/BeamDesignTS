...
export const useBeamAnalysis = ({
  ...
  moments,
  memberProperties
}: BeamAnalysisProps): BeamAnalysisResults | null => {
  ...
  useEffect(() => {
    ...
    // Calculate the deflection and perform beam analysis
    const analyzeBeam = () => {
    ...
    // Perform the analysis and update the results
    const analysisResults = analyzeBeam();
    setResults(analysisResults);
  }, [span, members, ws, wl, J2, udlLoads, pointLoads, moments, memberProperties]);
