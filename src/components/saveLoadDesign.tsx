...
export const SaveLoadDesign: React.FC<SaveLoadDesignProps> = ({ onImportComplete }) => {
    ...
    const handleExport = () => {
        try {
            // Use the built-in function to export with custom filename format
            exportDesignData(); // Let the utility function handle the filename

            // Show success message
            setImportStatus({ success: true, message: `Design exported successfully` });
